...
public class Main {
    // CHALLENGE
    // Modify the previous HeavenlyBody example so that the HeavenlyBody class also has
    //      a "bodyType" field. This field will store the type of HeavenlyBody (PLANET, DWARF_PLANET, MOON).
    ...
    //          and a BodyType. key is initialised with a new Key object and satellites
    //          is initialised with a new HashSet.
    //    - Eight methods:
    ...
    //      => equals(), override method declared as public final. Two HeavenlyBody objects are equal
