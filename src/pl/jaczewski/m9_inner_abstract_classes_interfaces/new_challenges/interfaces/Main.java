...
public class Main {
    ...
    //      => toString(), Players overriding toString() method. It takes no arguments and returns
    ...
    //      => read(), same as interface. Store the values in the List, in the order they appear in toString().
    //			Make sure the List is not null and the size() is greater than 0 before storing the values.
    //      => toString(), Monsters overriding toString() method. It takes no arguments and returns
    //			a String in the following format:
    ...
    public static void main(String[] args) {
        // Poniżej kod do testowania poprawności w czasie pisania kodu
        // Rozwiązanie sprawdzane przez bota na stronie kursu (Udemy)
        Player player = new Player("Tim", 10, 15);
        Player player2 = new Player("-", 0, 0);
        System.out.println(player);

        List<String> list = player.write();
