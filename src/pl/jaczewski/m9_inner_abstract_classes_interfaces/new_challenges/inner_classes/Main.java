...
public class Main {
    ...
    //      => add - accepts a parameter of type Song. This method returns a boolean value
    //	        which will be false if the song is found to already be in the songs list.
    //	        If not, the song will be added to the list and a value of true will be returned.
    //      => findSong - accepts the title of a song as its only parameter.
    ...
    //      => findSong - overridden method which accepts a track number for a song. The track number is of type int.
