...
public class Main {
    ...
    //
    // For the base Hamburger class, there will need to be four variables
    // to represent the four basic ingredients of the hamburger, name, meat, price, and breadRollType.
    // The price variable should be of type double, while the other three are of type String.
    // A constructor will be needed to accept these four values as parameters
    ...
    // Those should be declared with these names: addition1Name, addition1Price,
    // addition2Name, addition2Price, addition3Name, addition3Price, addition4Name, and addition4Price.
    ...
    // Four(4) for adding up to four additions to the hamburger and one(1) for printing out an itemized listing
    // of the final hamburger with addons, if any, and the total price.
    ...
    // and a drink for a base price of $19.10.
    // The constructor can be configured in any way, as long as chips and drink are added
    // for the total price just mentioned.
    // In this class, the four(4) methods defined in the Hamburger class for including
    // additional toppings must each be overridden so that a message is printed
