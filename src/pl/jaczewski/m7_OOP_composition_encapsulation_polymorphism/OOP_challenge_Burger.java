...
public class OOP_challenge_Burger {
    ...
    protected String addition3;
    protected String addition4;
    protected double additionPrice;
    protected int numberOfAdditions;

    public OOP_challenge_Burger(String breadType, String name) {
        this.name = name;
        this.breadType = breadType;
        this.meat = true;
        this.numberOfAdditions = 0;
        this.basePrice = 15.00;
        this.additionPrice = 2.00;
        System.out.println("You have chosen a " + this.name + " Burger on a " + this.breadType + " bread.");
    }

    public int addIngredient(String addition){
        if (numberOfAdditions >= 4){
            System.out.println("You cannot add more than 4 additions to the " + name + " Burger.");
    ...
    public double calculatePrice(){
        return this.basePrice + this.numberOfAdditions * this.additionPrice;
    }
    ...
    public void priceCalculationScheme(){
        System.out.println("Base price for " + name + " Burger is " + basePrice + " and any extra ingredient costs " + additionPrice + ".");
    }
