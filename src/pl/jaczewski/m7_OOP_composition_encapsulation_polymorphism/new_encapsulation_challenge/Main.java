package pl.jaczewski.m7_OOP_composition_encapsulation_polymorphism.new_encapsulation_challenge;
...
public class Main {
    ...
    // The constructor will accept two of these variables, tonerLevel and duplex,
    ...
    //    A variable called pagesToPrint should be created and initialized
    //    to the value of the incoming parameter.
    //    A conditional check should be performed on whether the Printer class field,
    //    duplex, is either "true" or "false".
    ...
    //    You can include a message in the printPages method which informs the user
    ...
    //    And the modulo "%" operator divides the number and returns only the remainder,
