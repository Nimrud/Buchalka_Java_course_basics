...
public class X_exercise34_ComplexNumber {

    private double real;
    private double imaginary;

    public X_exercise34_ComplexNumber(double real, double imaginary) {
        this.real = real;
    ...
    public void add(X_exercise34_ComplexNumber complexNumber){
    ...
    public void subtract(X_exercise34_ComplexNumber complexNumber){
        this.real -= complexNumber.real;
        this.imaginary -= complexNumber.imaginary;
    }
}
