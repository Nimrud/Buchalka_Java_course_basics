...
public class X_exercise32_Point {

    private int x;
    private int y;

    public X_exercise32_Point(int x, int y) {
        this.x = x;
        this.y = y;
    }

    public X_exercise32_Point() {
    }
    ...
    public double distance(){
        return Math.sqrt( (double) (this.x - 0) * (double) (this.x - 0) + (double) (this.y - 0) * (double) (this.y - 0) );
    }

    public double distance(int x, int y){
        return Math.sqrt( (double) (this.x - x) * (double) (this.x - x) + (double) (this.y - y) * (double) (this.y - y) );

    }

    public double distance(X_exercise32_Point another){
       return Math.sqrt( (double) (this.x - another.x) * (double) (this.x - another.x) + (double) (this.y - another.y) * (double) (this.y - another.y) );
    }
